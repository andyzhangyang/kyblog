...
import com.zhang.exception.ApiInvalidParamException;
import com.zhang.exception.BusinessException;
import com.zhang.exception.ErrorMessageUtil;
import com.zhang.global.ErrorConstants;
...
public class HandlerExceptionResolver implements org.springframework.web.servlet.HandlerExceptionResolver {
    ...
    public ModelAndView resolveException(HttpServletRequest request, HttpServletResponse response, Object handler, Exception exception) {
        ...
        try (PrintWriter writer = response.getWriter()) {
            writer.write(Objects.requireNonNull(JsonUtils.objectToJson(Result.createWithErrorMessage(message, errorCode))));
        } catch (Exception e) {
